"""
CS528 HW4 – Service 2: Pub/Sub subscriber for forbidden-country requests.
Runs on its own VM instance.  Receives messages published by Service 1
and prints them to stdout (viewable via journalctl on the VM).
Also appends each event to a log file in GCS.
"""
...
def append_to_gcs_log(line):
    """Read-modify-write a single line to the GCS log blob."""
