"""
CS528 HW9 – Service 2: Pub/Sub subscriber for forbidden-country requests.
Run on a GCE VM (or anywhere with credentials). Receives messages published
by the GKE web server and prints them to stdout. Also appends each event to
a log blob in GCS (same as HW4).
"""
